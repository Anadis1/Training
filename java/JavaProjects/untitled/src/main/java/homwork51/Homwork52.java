package homwork51;//Вы работаете с приложением для учета имен пользователей. Ваша задача - разработать программу, которая принимает на
// вход пять имен пользователей (или использует имена по умолчанию, если аргументы не предоставлены) и подсчитывает,
...
class NamesCounter {
    ...
    public void addName(String name) {
        ...
        if (temp != null){
            Integer temp2 = names.get(name);
            temp2 = temp2 + 1;
            names.put(name, temp2);
        }
